...
export const theme = extendTheme({
  ...
  fonts: {
    // Amina's fonts from DESIGN.md
    heading: `'Exo 2', ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, Noto Sans, sans-serif`,
    body: `'Nunito Sans', ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, Noto Sans, sans-serif`,
  },
  components: {
    Button: buttonStyles,
    Switch: switchStyles,
