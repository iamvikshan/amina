...
export const CTAGuardian: FC<CTAGuardianProps> = ({ ping, status }) => {
  ...
  const script = `
    ...
    const container = document.querySelector('.particles-cta');
    if (container) {
      for (let i = 0; i < 40; i++) {
        const particle = document.createElement('div');
        particle.className = 'particle-cta';
        particle.style.cssText =
          ...
          'animation: particle-rise ' + (Math.random() * 10 + 5) + 's linear infinite;' +
    ...
    style.textContent =
      ...
      '50% { opacity: 0.4; }' +
      '100% { transform: translateY(-100vh) translateX(' + driftX + 'px); opacity: 0; }' +
      '}';
    ...
    <>
      <section class="py-20 md:py-32 bg-gradient-to-b from-night-shadow via-night-steel/30 to-night-shadow relative overflow-hidden">
        <div class="absolute inset-0">
          ...
          <div class="particles-cta absolute inset-0" />
        </div>
          ...
          <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            <div class="flex-1 flex justify-center lg:justify-end">
              <div class="relative group">
                ...
                <div class="relative">
                  ...
                  <div class="absolute top-10 -left-10 animate-float-delayed-1">
                    <div class="px-4 py-2 bg-night-steel/80 backdrop-blur-md border border-cyber-blue rounded-xl text-cyan-400 text-sm font-mono shadow-glow-blue">
                      [System: Ready]
                    </div>
                  </div>

                  <div class="absolute top-32 -right-10 animate-float-delayed-2">
                    <div
                      class="px-4 py-2 bg-night-steel/80 backdrop-blur-md border rounded-xl text-sm font-mono"
                      style={`border-color: ${currentStatus.borderColor}; color: ${currentStatus.textColor}; box-shadow: 0 0 20px ${currentStatus.glowColor};`}
                    >
                      [Status: {currentStatus.label}]
                    </div>
                  </div>

                  <div class="absolute bottom-20 -left-8 animate-float-delayed-3">
                    <div class="px-4 py-2 bg-night-steel/80 backdrop-blur-md border border-amina-crimson rounded-xl text-amina-crimson text-sm font-mono shadow-glow-red">
                      [Ping: {ping}ms]
                    </div>
                  </div>
                </div>
            ...
            <div class="flex-1 text-center lg:text-left space-y-8">
              <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-night-steel/50 backdrop-blur-md border border-amina-crimson/30 text-amina-crimson">
                <LucideIcon name="heart" class="text-amina-crimson" size={20} />
              ...
              <div class="flex flex-col sm:flex-row items-center gap-4 pt-4">
                ...
                >
                  ...
                  <span>Add Amina to Discord</span>
                  <svg
                ...
                <a
                  href="/dash"
                  class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-5 bg-transparent border-2 border-cyber-blue text-cyber-blue rounded-xl font-heading font-bold text-lg hover:bg-cyber-blue/10 hover:scale-105 transition-all duration-300"
                >
                  <svg
                    class="w-5 h-5"
                    fill="none"
              ...
              <div class="flex flex-wrap items-center justify-center lg:justify-start gap-4 pt-4 text-sm text-gray-400">
