...
// Get CLIENT_ID from environment (both build-time and runtime)
// For build-time: use import.meta.env.CLIENT_ID
// For runtime: falls back to process.env.CLIENT_ID
const getClientId = (): string => {
  if (typeof import.meta !== 'undefined' && import.meta.env?.CLIENT_ID) {
    return import.meta.env.CLIENT_ID;
  }
 ...
 * @param path - Path relative to site root (e.g., '/dash' or 'dash')
